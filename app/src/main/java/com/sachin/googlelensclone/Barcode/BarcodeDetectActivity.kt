...
import com.sachin.googlelensclone.ImageLabel.ImageLabelAnalyzer
...
class BarcodeDetectActivity : AppCompatActivity() {
    private lateinit var cameraExecutor: ExecutorService

    private val imageAnalyzer: ImageAnalysis.Analyzer = BarcodeDetectAnalyzer()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnBarcodeScaner.setOnClickListener {
            scanBarcode()
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            val preview = Preview.Builder()
                .build()
                .also {
                    it.setSurfaceProvider(BarcodeviewFinder.surfaceProvider)
                }
